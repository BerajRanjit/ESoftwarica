...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Students students = new Students("admin", "bouddha", "Male", "21",R.drawable.noimg);
        studentsList = students.getStudentsList();
        if (studentsList.isEmpty()){
            studentsList.add(new Students("Beraj Ranjit", "Bouddha", "Male", "21", R.drawable.maleimg));
            studentsList.add(new Students("Akrity Gurung", "Kapan", "Female", "20", R.drawable.femaleimg));
